# Welcome, digital-demigods, to the 2024 TDI Global Hackathon
## Contents
1. [Bye bye]()
...
8. Navigate to https://console.cloud.google.com/home/dashboard?project=hack-team-digital-demigods.
...
you must attach your Workload SA (workload@hack-team-digital-demigods.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom SA".
...
(typically `"serviceAccount": "workload@hack-team-digital-demigods.iam.gserviceaccount.com"`, to be added as a peer of the `"name": "..."` or `"displayName" : "..."` attribute) 
